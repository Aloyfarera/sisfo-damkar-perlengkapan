    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <?= form_open('', [], ['id_kendaraan' => $perlengkapan['id_kendaraan']]); ?>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <textarea name="keterangan" id="keterangan" class="form-control" rows="4" placeholder="Keterangan..."><?= set_value('kondisi_real'); ?></textarea>
                        </div>
