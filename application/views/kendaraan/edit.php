    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <?= form_open(); ?>
                <input value="<?= $kendaraan['id_kendaraan']; ?>" name="id_kendaraan" id="id_kendaraan" type="hidden" class="form-control">
                <div class="row form-group">
                    <label class="col-md-3 text-md-right pt-1" for="jns_kendaraan">Jenis Kendaraan</label>
                    <div class="col-md-9">
                        <div class="input-group">
                            <input value="<?= $kendaraan['jns_kendaraan']; ?>" name="jns_kendaraan" id="jns_kendaraan" 
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            <input value="<?= $kendaraan['merk']; ?>" name="merk" id="merk" type="text" class="form-control" placeholder="Merk Kendaraan" required>
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            <input value="<?= $kendaraan['no_polisi']; ?>" name="no_polisi" id="no_polisi" type ="text" class="form-control"  placeholder="Nomor Polisi" required>
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            <input value="<?= $kendaraan['no_lbg']; ?>" name="no_lbg" id="no_lbg" type="text" class="form-control" placeholder="Nomor Lambung" required>
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= $kendaraan['thn_pembuatan'];  ?>" name="thn_pembuatan" id="thn_pembuatan" type="text" class="form-control" placeholder="Tahun Pembuatan" required>
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            <input value="<?= $kendaraan['warna']; ?>" name="warna" id="warna" type="text" class="form-control" placeholder="Warna Kendaraan" required>
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-control" id="bahan_bakar" name="bahan_bakar" required>
                                <?php foreach( $bbm as $b): ?>
                                    <?php if( $b == $kendaraan['bahan_bakar']):?>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            <input value="<?= $kendaraan['no_bpkb']; ?>" name="no_bpkb" id="no_bpkb" type="text" class="form-control" placeholder="Nomor BPKB" required>
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            <input value="<?= $kendaraan['no_mesin']; ?>" name="no_mesin" id="no_mesin" type="text" class="form-control" placeholder="Nomor Mesin" required>
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            <input value="<?= $kendaraan['no_rangka']; ?>" name="no_rangka" id="no_rangka" type="text" class="form-control" placeholder="Nomor Rangka" required>
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            <input value="<?= $kendaraan['asal_kendaraan']; ?>" name="asal_kendaraan" id="asal_kendaraan" type="text" class="form-control" placeholder="Asal Kendaraan" required>
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            <input value="<?= $kendaraan['kondisi_kndrn']; ?>" name="kondisi_kndrn" id="kondisi_kndrn" type="text" class="form-control" placeholder="Kondisi" required>
                        </div>
