    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <input value="<?= $alat['id_alat'];?>" name="id_alat" id="id_alat" type="hidden" class="form-control" placeholder="Nama Perlengkapan" required>

                <div class="row form-group">
                    <label class="col-md-3 text-md-right pt-1" for="nama"> Nama Perlengkapan </label></label>
                    <div class="col-md-9">
                        <div class="input-group">
                            <input value="<?= $alat['nama'];?>" name="nama" id="nama" 
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            <input value="<?= $alat['jumlah'];?>" name="jumlah" id="jumlah" type="number" class="form-control" placeholder="jumlah Perlengkapan" required>
                        </div>
